...
- (UILabel *)titleLabel
{
  if (!_titleLabel) {
    _titleLabel = [[UILabel alloc] initWithFrame:self.contentView.bounds];
      //
      _titleLabel.backgroundColor = UIColorFromRGB(0xe1e2e5);
...
- (UICollectionView *)segmentBar
{
  if (!_segmentBar) {
    ...
    _segmentBar.backgroundColor = UIColorFromRGB(0xe1e2e5);
    ...
    [separator setBackgroundColor:UIColorFromRGB(0xe1e2e5)];
