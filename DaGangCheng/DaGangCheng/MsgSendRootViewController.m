...
@interface MsgSendRootViewController ()

@end

@implementation MsgSendRootViewController
...
- (void)viewDidLoad
{
    ...
    NSArray* list = self.childViewControllers;
    MsgSendViewController* view = list[0];
    view.uid =self.uid;
    view.name=self.name;
    view.msg = self.msg;
}
