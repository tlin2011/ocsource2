...
- (void)initSubviews {
    ...
    self.addIco = [[UIImageView alloc] initWithFrame:CGRectZero];
    self.addIco.image = [[UIImage imageNamed:@"定位_附近的人.png"] imageWithMobanThemeColor];
    [self addSubview:self.addIco];
}
